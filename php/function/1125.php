    ...
    <!-- <div class="container-fluid">
        <div class="row">
            <div class="col-sm box ">
                <div class="h-50 bg-cover" style="background-image: url('https://picsum.photos/id/237/200/300')"></div>
                <div class="h-50 bg-cover" style="background-image: url('https://picsum.photos/id/238/200/300')"></div>
            </div>
        </div>
    </div> -->
